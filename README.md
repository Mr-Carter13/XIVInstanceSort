...
The version in this repo is built for instances (dungeons, trials, raids, etc.) from the MMO [Final Fantasy XIV](https://na.finalfantasyxiv.com/),
but the sorter can be easily edited to create any custom sorter desired.

This was forked from [execfera/charasort](https://github.com/execfera/charasort) which is a character sorter dedicated to the [Touhou Project](https://en.wikipedia.org/wiki/Touhou_Project) game series.
